        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-1">
                    <button id="btnResendVerificationEmail" class="btn btn-default-fill btn-md btn-block initial-transform btn-resend-verify-email btn-action" data-email-sent="{$LANG.emailSent}" data-error-msg="{$LANG.error}" data-uri="{routePath('user-email-verification-resend')}">
