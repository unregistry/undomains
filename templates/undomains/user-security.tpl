...
<div class="text-center">
    <p class="section-subheading mergecolor">{lang key='userManagement.settings'}</p>
</div>


<div class="bg-seccolorstyle bg-white br-12 border-0 mergecolor p-50 p-relative noshadow mt-5">
    {if $linkableProviders }
        <h2>{lang key='remoteAuthn.titleLinkedAccounts'}</h2>
