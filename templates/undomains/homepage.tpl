					...
					<div class="col-12">
						<div class="service-section bg-pratalight bg-seccolorstyle noshadow">
							...
							<div class="news-content-footer">
								...
								<a class="btn btn-default-yellow-fill" href="{routePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)|replace:'/index.php?rp=/':'/'|replace:'.html':''}"> {$LANG.readmore} <i class="ico-eye f-14 w-icon"></i></a>
							</div>
						</div>
					</div>
				{/if}
