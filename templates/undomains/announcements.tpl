        ...
        {foreach from=$announcements item=announcement}
            <div class="col-md-12 col-lg-4" data-aos="fade-up" data-aos-duration="1000">
                <div class="service-section bg-seccolorstyle bg-white noshadow">
                    ...
                    {/if}
                    {if $announcementsFbRecommend}
                        <div class="fb-like hidden-sm hidden-xs" data-layout="standard" data-href="{fqdnRoutePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)|replace:'/index.php?rp=':'/'|replace:'.html':''}" data-send="true" data-width="450" data-show-faces="true" data-action="recommend"></div>
                        <div class="fb-like hidden-lg hidden-md" data-layout="button_count" data-href="{fqdnRoutePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)|replace:'/index.php?rp=':'/'|replace:'.html':''}" data-send="true" data-width="450" data-show-faces="true" data-action="recommend"></div>
                    {/if}
                    <a href="{routePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)|replace:'/index.php?rp=':'/'|replace:'.html':''}" class="btn btn-default-yellow-fill">{$LANG.news}</a>
                </div>
            </div>
        {foreachelse}
    </div>
