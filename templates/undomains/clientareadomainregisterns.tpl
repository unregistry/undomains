<h2 class="mergecolor text-center mb-5">{$LANG.domainregisterns}</h2>
...
<div class="bg-seccolorstyle bg-white mergecolor br-12 p-relative p-50 mb-5">
    <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
        ...
        <h3 class="mergecolor mb-5">{$LANG.domainregisternsreg}</h3>
...
<div class="bg-seccolorstyle bg-white mergecolor br-12 p-relative p-50 mb-5">
    <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
        ...
        <input type="hidden" name="domainid" value="{$domainid}" />
        <h3 class="mergecolor mb-5">{$LANG.domainregisternsmod}</h3>
        <div class="form-group">
...
<div class="bg-seccolorstyle bg-white mergecolor br-12 p-relative p-50 mb-5">
    <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domainregisterns">
        ...
        <input type="hidden" name="domainid" value="{$domainid}" />
        <h3 class="mergecolor mb-5">{$LANG.domainregisternsdel}</h3>
        <div class="form-group">
