...
function setCookie(name,value,days) {
  ...
  function undomainsSettings({layout,color,background,font,header,radius,showSettings}){
  ...
  body = $('body');
  undomainsSettings.prototype.manageSettings = function(){
  ...
  undomainsSettings.prototype.manageHeader = function() {
    switch(this.header){
        case "static":
  ...
  undomainsSettings.prototype.manageLayout = function() {
    switch(this.layout){
        case "wide":
  ...
  undomainsSettings.prototype.manageColor = function() {
    switch(this.color){
        case "pink":
  ...
  undomainsSettings.prototype.manageBackground = function() {
...
undomainsSettings.prototype.manageRadius = function() {
    switch(this.radius){
        case "defaultradius":
...
undomainsSettings.prototype.manageFont = function() {
    switch(this.font){
        case "opensans":
            ...
            function getServicesInfo() {
                var info = {
                    VPS1: {
                        ...
                        price: "99.09",
                        priceon: "8.26",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=add&pid=4"
                    },
                    VPS2: {
                        name: "Service B",
                        disk: "200GB",
                        ...
                        price: "155.00",
                        priceon: "12.92",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=add&pid=5"
                    },
                    VPS3: {
                        name: "Service C",
                        disk: "300GB",
                        ...
                        price: "299.99",
                        priceon: "25.00",
                        orderlink: "http://inebur.com/whmcs/cart.php?a=add&pid=6"
                    },
                    VPS4: {
                        name: "Service D",
                        disk: "400GB",
