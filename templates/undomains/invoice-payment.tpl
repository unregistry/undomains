...
{else}
    ...
    <form id="frmPayment" method="post" action="{$submitLocation}" class="form-horizontal" role="form">
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="bg-seccolorstyle mergecolor br-12 p-50 mb-50">
                    ...
                    <div id="btnSubmitContainer" class="form-group submit-container">
                        <div class="text-center">
                            <button type="submit" class="btn btn-default-yellow-fill mt-10" id="btnSubmit" value="{lang key='submitpayment'}">
