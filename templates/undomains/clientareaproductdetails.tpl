...
<div class="tab-content margin-bottom mt-50">
            ...
            {foreach from=$addons item=addon}
                <div class="col-xs-6">
                    <div class="panel panel-default panel-accent-blue">
                        <div class="panel-heading bg-seccolorstyle bg-pratalight">
                            <h4 class="d-inline mergecolor">{$addon.name}</h4>
                            <div class="pull-right status-{$addon.rawstatus|strtolower}">{$addon.status}</div>
                        </div>
                        <div class="row panel-body bg-seccolorstyle bg-pratalight">
                            <div class="col-md-12">
                                <h3 class="mergecolor">{$addon.pricing}</h3>
                                <p class="mergecolor">{$LANG.registered}: {$addon.regdate}</p>
                                <p class="mergecolor">{$LANG.clientareahostingnextduedate}: {$addon.nextduedate}</p>
                            </div>
                        </div>
                        <div class="panel-footer">
                            <span>{$addon.managementActions}</span>
                        </div>
                    </div>
                </div>
            {/foreach}
