<div class="bg-seccolorstyle bg-white mergecolor br-12 p-50 mt-50">
    <form method="post" action="{$smarty.server.PHP_SELF}?action=bulkdomain" class="form-horizontal">
        ...
        <h3 class="mt-5">{$LANG.domainbulkmanagementchangesaffect}</h3>

        <blockquote class="bg-pratalight py-5 br-12">
        ...
        <h3 class="mt-5">{$LANG.domainbulkmanagementchangeaffect}</h3>
        ...
        <p align="center">
            <a href="clientarea.php?action=domains" class="btn btn-default mr-20">{$LANG.clientareabacklink}</a>
            <input type="submit" name="enable" value="{$LANG.domainsautorenewenable}" class="btn btn-success btn-lg" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="disable" value="{$LANG.domainsautorenewdisable}" class="btn btn-danger btn-large" />
        </p>
        ...
        <p align="center">
            <a href="clientarea.php?action=domains" class="btn btn-default mr-20">{$LANG.clientareabacklink}</a>
            <input type="submit" name="enable" value="{$LANG.domainreglockenable}" class="btn btn-success btn-lg" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="disable" value="{$LANG.domainreglockdisable}" class="btn btn-danger btn-large" />
        </p>
