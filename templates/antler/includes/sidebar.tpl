        ...
        {if $item->hasChildren()}
            <div {if $item->getChildrenAttribute('class')} {$item->getChildrenAttribute('class')}{/if}">
                {foreach $item->getChildren() as $childItem}
                    ...
                    {else}
                        <div menuItemName="{$childItem->getName()}" class="list-group-item mergecolor {if $childItem->getClass()} {$childItem->getClass()}{/if}" id="{$childItem->getId()}">
            ...
            <div class="panel-body mergecolor">
                <form role="form">
                    <select class="form-control" onchange="selectChangeNavigate(this)">
                        {foreach $item->getChildren() as $childItem}
                            <option menuItemName="{$childItem->getName()}" value="{$childItem->getUri()}" class="list-group-item mergecolor" {if $childItem->isCurrent()}selected="selected"{/if}>
                                {$childItem->getLabel()}
