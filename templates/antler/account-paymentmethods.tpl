...
<p class="section-subheading mergecolor text-center">{$LANG.paymentMethods.intro}</p>

<section class="pay-method mt-50">
    <p>
        {if $allowCreditCard}
            <a href="{routePath('account-paymentmethods-add')}" data-role="add-new-credit-card" class="badge feat bg-default mr-30" data-toggle="tooltip" data-placement="left" title="" data-original-title="{$LANG.paymentMethods.addNewCC}"><i class="ico-credit-card f-16"></i> </a>
        {/if}
        {if $allowBankDetails}
    ...
    <div class="table-responsive">
        <table class="table table-list" id="payMethodList">
            <thead>
                <tr>
                    <th></th>
